...
export type audit_logWhereInput = {
  ...
  executed_at?: Prisma.DateTimeFilter<"audit_log"> | Date | string
}
...
export type audit_logScalarWhereWithAggregatesInput = {
  ...
  executed_at?: Prisma.DateTimeWithAggregatesFilter<"audit_log"> | Date | string
}
...
export type audit_logOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "table_name" | "operation" | "old_data" | "new_data" | "executed_at", ExtArgs["result"]["audit_log"]>
...
export interface audit_logFieldRefs {
  ...
  readonly executed_at: Prisma.FieldRef<"audit_log", 'DateTime'>
}
